...
The sample_outputs directory contains examples of the high-quality outputs
that py4csr can generate for regulatory submissions:

Tables:
- t_dem.rtf: Demographics and baseline characteristics
- t_ae_sum.rtf: Adverse events summary
- t_vs_sum.rtf: Vital signs analysis

Figures:
- km_enhanced_example.rtf: Kaplan-Meier survival plots
- forest_enhanced_example.rtf: Forest plots for efficacy
