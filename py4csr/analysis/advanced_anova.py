...
def advanced_anova_analysis(
    ...
    diagnostics = {
        ...
        "homoscedasticity_test": stats.levene(
            *[
                data[data[treatment_var] == group][dependent_var]
...
def repeated_measures_anova(
    ...
    try:
        ...
        return {"error": str(e), "method": "Repeated Measures ANOVA"}
...
def mixed_effects_anova(
    ...
    try:
        ...
        if group_var and random_effects:
            ...
            model = mixedlm(
                formula, data, groups=data[group_var], re_formula=re_formula
            )
        else:
            model = mixedlm(
                formula, data, groups=data[group_var] if group_var else None
            )
        ...
        return {"error": str(e), "method": "Mixed Effects ANOVA"}
