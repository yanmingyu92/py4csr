...
def repeated_measures_analysis(
    data: pd.DataFrame,
    subject_col: str,
    treatment_col: str,
    time_col: str,
...
def change_from_baseline_analysis(
    data: pd.DataFrame,
    subject_col: str,
    treatment_col: str,
    baseline_col: str,
    ...
    results = {"analysis_type": "Change from Baseline Analysis"}
    ...
    if visit_col:
        ...
        overall_analysis = _perform_ancova_analysis(
            data, "change_from_baseline", treatment_col, baseline_col, covariates
        )
...
def _perform_ancova_analysis(
    ...
    try:
        ...
        for group in treatment_groups:
            ...
            if len(group_data) > 0:
                ...
                pred_data = pd.DataFrame(
                    {treatment_col: [group], baseline_col: [data[baseline_col].mean()]}
                )
        ...
        analysis_result = {"error": str(e), "formula": formula}
