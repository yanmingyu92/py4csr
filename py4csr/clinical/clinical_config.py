...
class ClinicalConfig:
    ...
    def get_decimal_places(
        self, variable_name: str, variable_type: str = "continuous"
    ) -> int:
        """
    ...
    def get_statistical_test(
        self, variable_type: str, n_groups: int, small_counts: bool = False
    ) -> str:
        """
    ...
    def format_statistic(
        self, value: float, stat_type: str, decimal_places: int = None
    ) -> str:
        """
