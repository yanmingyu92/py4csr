...
from .report_config import PageSettings, ReportConfig, StatisticConfig
...
def get_clinical_standard_config() -> ReportConfig:
    ...
    statistics = {
        "n": StatisticConfig(
            name="n", display="n", label="Number of subjects", precision=0
        ),
        "mean": StatisticConfig(name="mean", display="Mean", label="Mean", precision=1),
        "std": StatisticConfig(
            name="std", display="SD", label="Standard Deviation", precision=2
        ),
        "stderr": StatisticConfig(
            name="stderr", display="SE", label="Standard Error", precision=2
        ),
        ...
        "median": StatisticConfig(
            name="median", display="Median", label="Median", precision=1
        ),
        "min": StatisticConfig(name="min", display="Min", label="Minimum", precision=0),
        "max": StatisticConfig(name="max", display="Max", label="Maximum", precision=0),
        ...
        "q1": StatisticConfig(
            name="q1", display="Q1", label="First Quartile", precision=1
        ),
        "q3": StatisticConfig(
            name="q3", display="Q3", label="Third Quartile", precision=1
        ),
        ...
        "cv": StatisticConfig(
            name="cv", display="CV%", label="Coefficient of Variation (%)", precision=1
        ),
        "gmean": StatisticConfig(
            name="gmean", display="Geometric Mean", label="Geometric Mean", precision=2
        ),
...
def get_regulatory_submission_config() -> ReportConfig:
    ...
    additional_stats = {
        ...
        "p25": StatisticConfig(
            name="p25", display="25th percentile", label="25th Percentile", precision=1
        ),
        "p75": StatisticConfig(
            name="p75", display="75th percentile", label="75th Percentile", precision=1
        ),
