...
from ..data.io import load_dataset, read_sas
...
class ReportSession:
    ...
    def load_datasets(
        ...
        datasets: Optional[Dict[str, Union[str, pd.DataFrame]]] = None,
    ) -> "ReportSession":
        """
    ...
    def add_survival_analysis(self, **kwargs) -> "ReportSession":
        """Add survival analysis table (time-to-event)."""
        return self._add_table("survival", **kwargs)
    ...
    def generate_all(self, output_dir: str = "output") -> "ReportSession":
        ...
        for table_spec in self.tables:
            try:
                ...
                print(
                    f"✓ Generated {table_spec['type']}: {table_spec.get('title', 'Untitled')}"
                )
    ...
    def finalize(self) -> "ReportSessionResult":
        ...
        return ReportSessionResult(
            session=self, summary=summary, generated_files=self.generated_outputs
        )
    ...
    def _generate_session_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            - self.metadata.get("created_date", datetime.now()),
            "success": True,
        }
