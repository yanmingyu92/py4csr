...
class AESummaryGenerator(BaseTableGenerator):
    ...
    def _generate_ae_summary(
        self, data: pd.DataFrame, trt_var: str, spec: TableSpecification
    ) -> pd.DataFrame:
        ...
        # Header row
        header_row = {"AE Category": "Adverse Event Category", "Statistic": "n (%)"}
    ...
    def _calculate_ae_category(
        ...
        row = {"AE Category": category_name, "Statistic": ""}
