...
class TableResult:
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "validation_passed": (
                self.validation_results.get("passed", True)
...
class ReportResult:
    ...
    def get_file_summary(self) -> Dict[str, Any]:
        ...
        if not self.generated_files:
            return {"total_files": 0, "total_size_bytes": 0, "file_types": {}}
    ...
    def create_combined_rtf(self, output_path: Union[str, Path]) -> None:
        ...
        combined_content.append(
            r"\qc\b\fs24 "
            + self.metadata.get("title", "Clinical Study Report")
            + r"\b0\par"
        )
        combined_content.append(
            r"\qc\fs20 " + self.metadata.get("protocol", "") + r"\par"
        )
        combined_content.append(
            r"\qc\fs18 Generated: "
            + str(self.metadata.get("created_date", ""))
            + r"\par"
        )
            ...
            if rtf_file.exists():
                ...
                if start_idx != -1 and end_idx != -1:
                    ...
                    table_content = content[
                        start_idx + len(r"{\rtf1\ansi\deff0") : end_idx
                    ]
    ...
    def get_validation_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "validation_rate": (
                validated_tables / total_tables if total_tables > 0 else 0
            ),
